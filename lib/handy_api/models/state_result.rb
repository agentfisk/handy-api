...
module HandyAPI
  class StateResult
    ERROR = -1.freeze
    SUCCESS_NEW_STATE = 0.freeze
    SUCCESS_SAME_STATE = 1.freeze

    def self.all_vars
      @all_vars ||= [ERROR, SUCCESS_NEW_STATE, SUCCESS_SAME_STATE].freeze
    end
    ...
    def build_from_hash(value)
      return value if StateResult.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #StateResult"
    end
  end
end
