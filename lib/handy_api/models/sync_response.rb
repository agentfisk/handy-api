  ...
  class SyncResponse
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `HandyAPI::SyncResponse` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `HandyAPI::SyncResponse`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'dtserver')
        self.dtserver = attributes[:'dtserver']
      else
        self.dtserver = nil
      end
    end
    ...
    def list_invalid_properties
      ...
      if @dtserver.nil?
        invalid_properties.push('invalid value for "dtserver", dtserver cannot be nil.')
      end

      if @dtserver < 0
        invalid_properties.push('invalid value for "dtserver", must be greater than or equal to 0.')
      end
    ...
    def valid?
      ...
      return false if @dtserver.nil?
      return false if @dtserver < 0
      true
    end

    # Custom attribute writer method with validation
    # @param [Object] dtserver Value to be assigned
    def dtserver=(dtserver)
      if dtserver.nil?
        fail ArgumentError, 'dtserver cannot be nil'
      end

      if dtserver < 0
        fail ArgumentError, 'invalid value for "dtserver", must be greater than or equal to 0.'
      end
