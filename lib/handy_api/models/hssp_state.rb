...
module HandyAPI
  class HSSPState
    ...
    def self.all_vars
      @all_vars ||= [NEED_SYNC, NEED_SETUP, STOPPED, PLAYING].freeze
    end
    ...
    def build_from_hash(value)
      return value if HSSPState.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #HSSPState"
    end
  end
end
