...
module HandyAPI
  class FirmwareStatus
    UP_TO_DATE = 0.freeze
    UPDATE_REQUIRED = 1.freeze
    UPDATE_AVAILABLE = 2.freeze

    def self.all_vars
      @all_vars ||= [UP_TO_DATE, UPDATE_REQUIRED, UPDATE_AVAILABLE].freeze
    end
    ...
    def build_from_hash(value)
      return value if FirmwareStatus.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #FirmwareStatus"
    end
  end
end
