...
module HandyAPI
  class HAMPResponse
    ...
    attr_accessor :slide_max

    attr_accessor :slide_min
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `HandyAPI::HAMPResponse` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `HandyAPI::HAMPResponse`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'slide_max')
        self.slide_max = attributes[:'slide_max']
      else
        self.slide_max = nil
      end

      if attributes.key?(:'slide_min')
        self.slide_min = attributes[:'slide_min']
      else
        self.slide_min = nil
      end
    ...
    def list_invalid_properties
      ...
      if @slide_max.nil?
        invalid_properties.push('invalid value for "slide_max", slide_max cannot be nil.')
      end

      if @slide_max > 100
        invalid_properties.push('invalid value for "slide_max", must be smaller than or equal to 100.')
      end

      if @slide_max < 0
        invalid_properties.push('invalid value for "slide_max", must be greater than or equal to 0.')
      end

      if @slide_min.nil?
        invalid_properties.push('invalid value for "slide_min", slide_min cannot be nil.')
      end

      if @slide_min > 100
        invalid_properties.push('invalid value for "slide_min", must be smaller than or equal to 100.')
      end

      if @slide_min < 0
        invalid_properties.push('invalid value for "slide_min", must be greater than or equal to 0.')
      end

      if !@velocity.nil? && @velocity > 100
    ...
    def valid?
      ...
      return false if @slide_max.nil?
      return false if @slide_max > 100
      return false if @slide_max < 0
      return false if @slide_min.nil?
      return false if @slide_min > 100
      return false if @slide_min < 0
      return false if !@velocity.nil? && @velocity > 100
      return false if !@velocity.nil? && @velocity < 0
      true
    end

    # Custom attribute writer method with validation
    # @param [Object] slide_max Value to be assigned
    def slide_max=(slide_max)
      if slide_max.nil?
        fail ArgumentError, 'slide_max cannot be nil'
      end

      if slide_max > 100
        fail ArgumentError, 'invalid value for "slide_max", must be smaller than or equal to 100.'
      end

      if slide_max < 0
        fail ArgumentError, 'invalid value for "slide_max", must be greater than or equal to 0.'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] slide_min Value to be assigned
    def slide_min=(slide_min)
      if slide_min.nil?
        fail ArgumentError, 'slide_min cannot be nil'
      end

      if slide_min > 100
        fail ArgumentError, 'invalid value for "slide_min", must be smaller than or equal to 100.'
      end

      if slide_min < 0
        fail ArgumentError, 'invalid value for "slide_min", must be greater than or equal to 0.'
      end
    ...
    def hash
      [state, slide_max, slide_min, velocity].hash
    end
