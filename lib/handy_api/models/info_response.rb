...
module HandyAPI
  class InfoResponse
    ...
    # Device session id. Unique per connected session.
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `HandyAPI::InfoResponse` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `HandyAPI::InfoResponse`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'fw_status')
        self.fw_status = attributes[:'fw_status']
      else
        self.fw_status = nil
      end

      if attributes.key?(:'hw_version')
    ...
    def list_invalid_properties
      ...
      if @fw_version.nil?
        invalid_properties.push('invalid value for "fw_version", fw_version cannot be nil.')
      end

      if @fw_status.nil?
        invalid_properties.push('invalid value for "fw_status", fw_status cannot be nil.')
      end

      if @hw_version.nil?
        invalid_properties.push('invalid value for "hw_version", hw_version cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @fw_version.nil?
      return false if @fw_status.nil?
      return false if @hw_version.nil?
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          fw_status == o.fw_status &&
          hw_version == o.hw_version &&
          model == o.model &&
          branch == o.branch &&
    ...
    def hash
      [fw_version, fw_status, hw_version, model, branch, session_id].hash
    end
