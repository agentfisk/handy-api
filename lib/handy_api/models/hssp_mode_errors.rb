...
module HandyAPI
  class HSSPModeErrors
    ERROR = 4000.freeze
    DOWNLOAD_FAILED = 4001.freeze
    HASH_ERROR = 4002.freeze
    SYNC_REQUIRED = 4003.freeze
    TOKEN_ERROR = 4004.freeze
    MAX_SCRIPT_SIZE_ERROR = 4005.freeze
    DEVICE_STORAGE_FULL_ERROR = 4006.freeze
    DEVICE_STORAGE_FREE_ERROR = 4007.freeze
    DEVICE_STORAGE_CLEAN_ERROR = 4008.freeze

    def self.all_vars
      @all_vars ||= [ERROR, DOWNLOAD_FAILED, HASH_ERROR, SYNC_REQUIRED, TOKEN_ERROR, MAX_SCRIPT_SIZE_ERROR, DEVICE_STORAGE_FULL_ERROR, DEVICE_STORAGE_FREE_ERROR, DEVICE_STORAGE_CLEAN_ERROR].freeze
    end
    ...
    def build_from_hash(value)
      return value if HSSPModeErrors.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #HSSPModeErrors"
    end
  end
end
