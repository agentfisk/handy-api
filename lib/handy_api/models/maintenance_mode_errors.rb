...
module HandyAPI
  class MAINTENANCEModeErrors
    ERROR = 6000.freeze
    RESTART_FAILED = 6001.freeze

    def self.all_vars
      @all_vars ||= [ERROR, RESTART_FAILED].freeze
    end
    ...
    def build_from_hash(value)
      return value if MAINTENANCEModeErrors.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #MAINTENANCEModeErrors"
    end
  end
end
