...
module HandyAPI
  class Branch
    ...
    STAGING = "master-staging".freeze

    def self.all_vars
      @all_vars ||= [MASTER, STAGING].freeze
    end
    ...
    def build_from_hash(value)
      return value if Branch.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #Branch"
    end
  end
end
