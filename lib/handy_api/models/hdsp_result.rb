...
module HandyAPI
  class HDSPResult
    ERROR = -3.freeze
    SUCCESS_POSITION_REACHED = 0.freeze
    SUCCESS_POSITION_NOT_REACHED = 1.freeze
    SUCCES_ALREADY_AT_POSITION = 2.freeze
    SUCCESS_INTERRTUPTED = 3.freeze

    def self.all_vars
      @all_vars ||= [ERROR, SUCCESS_POSITION_REACHED, SUCCESS_POSITION_NOT_REACHED, SUCCES_ALREADY_AT_POSITION, SUCCESS_INTERRTUPTED].freeze
    end
    ...
    def build_from_hash(value)
      return value if HDSPResult.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #HDSPResult"
    end
  end
end
