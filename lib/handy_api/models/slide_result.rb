...
module HandyAPI
  class SlideResult
    ACCEPTED = 0.freeze
    ACCEPTED_ROUNDED_DOWN = 1.freeze
    ACCEPTED_ROUNDED_UP = 2.freeze

    def self.all_vars
      @all_vars ||= [ACCEPTED, ACCEPTED_ROUNDED_DOWN, ACCEPTED_ROUNDED_UP].freeze
    end
    ...
    def build_from_hash(value)
      return value if SlideResult.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #SlideResult"
    end
  end
end
