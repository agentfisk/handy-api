...
module HandyAPI
  class HSSPSetupResult
    USING_CACHED = 0.freeze
    DOWNLOADED = 1.freeze

    def self.all_vars
      @all_vars ||= [USING_CACHED, DOWNLOADED].freeze
    end
    ...
    def build_from_hash(value)
      return value if HSSPSetupResult.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #HSSPSetupResult"
    end
  end
end
