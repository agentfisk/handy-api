...
module HandyAPI
  class HSSPPlay
    ...
    attr_accessor :estimated_server_time
    ...
    def self.attribute_map
      {
        :'estimated_server_time' => :'estimatedServerTime',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `HandyAPI::HSSPPlay` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `HandyAPI::HSSPPlay`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'estimated_server_time')
        self.estimated_server_time = attributes[:'estimated_server_time']
      else
        self.estimated_server_time = nil
      end
    ...
    def list_invalid_properties
      ...
      if @estimated_server_time.nil?
        invalid_properties.push('invalid value for "estimated_server_time", estimated_server_time cannot be nil.')
      end

      if @estimated_server_time < 0
        invalid_properties.push('invalid value for "estimated_server_time", must be greater than or equal to 0.')
      end
      ...
      if @start_time < 0
        invalid_properties.push('invalid value for "start_time", must be greater than or equal to 0.')
      end
    ...
    def valid?
      ...
      return false if @estimated_server_time.nil?
      return false if @estimated_server_time < 0
    ...
    # @param [Object] estimated_server_time Value to be assigned
    def estimated_server_time=(estimated_server_time)
      if estimated_server_time.nil?
        fail ArgumentError, 'estimated_server_time cannot be nil'
      end

      if estimated_server_time < 0
        fail ArgumentError, 'invalid value for "estimated_server_time", must be greater than or equal to 0.'
      end
    ...
    def start_time=(start_time)
      ...
      if start_time < 0
        fail ArgumentError, 'invalid value for "start_time", must be greater than or equal to 0.'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          estimated_server_time == o.estimated_server_time &&
    ...
    def hash
      [estimated_server_time, start_time].hash
    end
