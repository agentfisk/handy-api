...
module HandyAPI
  class BASEModeErrors
    ERROR = 2000.freeze
    INVALID_REQUEST = 2001.freeze
    METHOD_NOT_FOUND = 2002.freeze

    def self.all_vars
      @all_vars ||= [ERROR, INVALID_REQUEST, METHOD_NOT_FOUND].freeze
    end
    ...
    def build_from_hash(value)
      return value if BASEModeErrors.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #BASEModeErrors"
    end
  end
end
