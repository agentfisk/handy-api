...
# Unit tests for HandyAPI::SLIDEApi
...
describe 'SLIDEApi' do
  ...
  describe 'test an instance of SLIDEApi' do
    it 'should create an instance of SLIDEApi' do
      expect(@api_instance).to be_instance_of(HandyAPI::SLIDEApi)
    end
  end

  # unit tests for get_position_abs
  ...
  describe 'get_position_abs test' do
    it 'should work' do
