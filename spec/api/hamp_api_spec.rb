...
# Unit tests for HandyAPI::HAMPApi
...
describe 'HAMPApi' do
  ...
  describe 'test an instance of HAMPApi' do
    it 'should create an instance of HAMPApi' do
      expect(@api_instance).to be_instance_of(HandyAPI::HAMPApi)
    end
  end

  # unit tests for get_hamp_state
  ...
  # @param x_connection_key Device connection key or a channel reference.
  # @param hamp_velocity_percent 
  # @param [Hash] opts the optional parameters
  # @return [SetHAMPVelocityPercent200Response]
  describe 'set_hamp_velocity_percent test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
