...
# Unit tests for HandyAPI::MAINTENANCEApi
...
describe 'MAINTENANCEApi' do
  ...
  describe 'test an instance of MAINTENANCEApi' do
    it 'should create an instance of MAINTENANCEApi' do
      expect(@api_instance).to be_instance_of(HandyAPI::MAINTENANCEApi)
    end
  end
  ...
  # unit tests for update_perform_fw
  # Perform firmware update.
  # Perform firmware update.
  # @param x_connection_key Device connection key.
  # @param update_perform 
  # @param [Hash] opts the optional parameters
  # @return [SetHAMPVelocityPercent200Response]
  describe 'update_perform_fw test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
