...
# Unit tests for HandyAPI::OTAApi
...
describe 'OTAApi' do
  ...
  describe 'test an instance of OTAApi' do
    it 'should create an instance of OTAApi' do
      expect(@api_instance).to be_instance_of(HandyAPI::OTAApi)
    end
  end

  # unit tests for latest
