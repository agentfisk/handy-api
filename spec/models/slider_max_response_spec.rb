...
# Unit tests for HandyAPI::SliderMaxResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe HandyAPI::SliderMaxResponse do
  let(:instance) { HandyAPI::SliderMaxResponse.new }

  describe 'test an instance of SliderMaxResponse' do
    it 'should create an instance of SliderMaxResponse' do
      expect(instance).to be_instance_of(HandyAPI::SliderMaxResponse)
    end
  end
