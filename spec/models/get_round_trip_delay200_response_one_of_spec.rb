...
# Unit tests for HandyAPI::GetRoundTripDelay200ResponseOneOf
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe HandyAPI::GetRoundTripDelay200ResponseOneOf do
  let(:instance) { HandyAPI::GetRoundTripDelay200ResponseOneOf.new }

  describe 'test an instance of GetRoundTripDelay200ResponseOneOf' do
    it 'should create an instance of GetRoundTripDelay200ResponseOneOf' do
      expect(instance).to be_instance_of(HandyAPI::GetRoundTripDelay200ResponseOneOf)
    end
  end
  ...
  describe 'test attribute "rtd"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
