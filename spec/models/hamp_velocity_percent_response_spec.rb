...
# Unit tests for HandyAPI::HAMPVelocityPercentResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe HandyAPI::HAMPVelocityPercentResponse do
  let(:instance) { HandyAPI::HAMPVelocityPercentResponse.new }

  describe 'test an instance of HAMPVelocityPercentResponse' do
    it 'should create an instance of HAMPVelocityPercentResponse' do
      expect(instance).to be_instance_of(HandyAPI::HAMPVelocityPercentResponse)
    end
  end
