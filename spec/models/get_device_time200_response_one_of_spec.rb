...
# Unit tests for HandyAPI::GetDeviceTime200ResponseOneOf
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe HandyAPI::GetDeviceTime200ResponseOneOf do
  let(:instance) { HandyAPI::GetDeviceTime200ResponseOneOf.new }

  describe 'test an instance of GetDeviceTime200ResponseOneOf' do
    it 'should create an instance of GetDeviceTime200ResponseOneOf' do
      expect(instance).to be_instance_of(HandyAPI::GetDeviceTime200ResponseOneOf)
    end
  end
