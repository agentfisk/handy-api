...
# Unit tests for HandyAPI::SettingsResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe HandyAPI::SettingsResponse do
  let(:instance) { HandyAPI::SettingsResponse.new }

  describe 'test an instance of SettingsResponse' do
    it 'should create an instance of SettingsResponse' do
      expect(instance).to be_instance_of(HandyAPI::SettingsResponse)
    end
  end
