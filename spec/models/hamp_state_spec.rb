...
# Unit tests for HandyAPI::HAMPState
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe HandyAPI::HAMPState do
  let(:instance) { HandyAPI::HAMPState.new }

  describe 'test an instance of HAMPState' do
    it 'should create an instance of HAMPState' do
      expect(instance).to be_instance_of(HandyAPI::HAMPState)
    end
  end
end
