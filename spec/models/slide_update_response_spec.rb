...
# Unit tests for HandyAPI::SlideUpdateResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe HandyAPI::SlideUpdateResponse do
  let(:instance) { HandyAPI::SlideUpdateResponse.new }

  describe 'test an instance of SlideUpdateResponse' do
    it 'should create an instance of SlideUpdateResponse' do
      expect(instance).to be_instance_of(HandyAPI::SlideUpdateResponse)
    end
  end
