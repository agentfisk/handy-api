...
# Unit tests for HandyAPI::HSSPPlayResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe HandyAPI::HSSPPlayResponse do
  let(:instance) { HandyAPI::HSSPPlayResponse.new }

  describe 'test an instance of HSSPPlayResponse' do
    it 'should create an instance of HSSPPlayResponse' do
      expect(instance).to be_instance_of(HandyAPI::HSSPPlayResponse)
    end
  end
