...
# Unit tests for HandyAPI::GetHSSPState200ResponseOneOf
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe HandyAPI::GetHSSPState200ResponseOneOf do
  let(:instance) { HandyAPI::GetHSSPState200ResponseOneOf.new }

  describe 'test an instance of GetHSSPState200ResponseOneOf' do
    it 'should create an instance of GetHSSPState200ResponseOneOf' do
      expect(instance).to be_instance_of(HandyAPI::GetHSSPState200ResponseOneOf)
    end
  end
