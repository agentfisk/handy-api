...
# Unit tests for HandyAPI::HSSPPlayResult
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe HandyAPI::HSSPPlayResult do
  let(:instance) { HandyAPI::HSSPPlayResult.new }

  describe 'test an instance of HSSPPlayResult' do
    it 'should create an instance of HSSPPlayResult' do
      expect(instance).to be_instance_of(HandyAPI::HSSPPlayResult)
    end
  end
end
