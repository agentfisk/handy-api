...
# Unit tests for HandyAPI::HSSPState
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe HandyAPI::HSSPState do
  let(:instance) { HandyAPI::HSSPState.new }

  describe 'test an instance of HSSPState' do
    it 'should create an instance of HSSPState' do
      expect(instance).to be_instance_of(HandyAPI::HSSPState)
    end
  end
end
