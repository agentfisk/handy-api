...
# Unit tests for HandyAPI::GetMode200ResponseOneOf
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe HandyAPI::GetMode200ResponseOneOf do
  let(:instance) { HandyAPI::GetMode200ResponseOneOf.new }

  describe 'test an instance of GetMode200ResponseOneOf' do
    it 'should create an instance of GetMode200ResponseOneOf' do
      expect(instance).to be_instance_of(HandyAPI::GetMode200ResponseOneOf)
    end
  end
