...
# Unit tests for HandyAPI::BASEModeErrors
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe HandyAPI::BASEModeErrors do
  let(:instance) { HandyAPI::BASEModeErrors.new }

  describe 'test an instance of BASEModeErrors' do
    it 'should create an instance of BASEModeErrors' do
      expect(instance).to be_instance_of(HandyAPI::BASEModeErrors)
    end
  end
end
