...
# Unit tests for HandyAPI::UpdateStatusResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe HandyAPI::UpdateStatusResponse do
  let(:instance) { HandyAPI::UpdateStatusResponse.new }

  describe 'test an instance of UpdateStatusResponse' do
    it 'should create an instance of UpdateStatusResponse' do
      expect(instance).to be_instance_of(HandyAPI::UpdateStatusResponse)
    end
  end
  ...
  describe 'test attribute "status"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('Float', [0, 1, 2, 3])
