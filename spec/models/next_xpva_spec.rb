...
# Unit tests for HandyAPI::NextXPVA
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe HandyAPI::NextXPVA do
  let(:instance) { HandyAPI::NextXPVA.new }

  describe 'test an instance of NextXPVA' do
    it 'should create an instance of NextXPVA' do
      expect(instance).to be_instance_of(HandyAPI::NextXPVA)
    end
  end
