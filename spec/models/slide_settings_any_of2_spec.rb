...
# Unit tests for HandyAPI::SlideSettingsAnyOf2
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe HandyAPI::SlideSettingsAnyOf2 do
  let(:instance) { HandyAPI::SlideSettingsAnyOf2.new }

  describe 'test an instance of SlideSettingsAnyOf2' do
    it 'should create an instance of SlideSettingsAnyOf2' do
      expect(instance).to be_instance_of(HandyAPI::SlideSettingsAnyOf2)
    end
  end
