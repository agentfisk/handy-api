...
# Unit tests for HandyAPI::HSSPSetupResult
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe HandyAPI::HSSPSetupResult do
  let(:instance) { HandyAPI::HSSPSetupResult.new }

  describe 'test an instance of HSSPSetupResult' do
    it 'should create an instance of HSSPSetupResult' do
      expect(instance).to be_instance_of(HandyAPI::HSSPSetupResult)
    end
  end
end
