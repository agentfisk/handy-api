...
# Unit tests for HandyAPI::GenericResultResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe HandyAPI::GenericResultResponse do
  let(:instance) { HandyAPI::GenericResultResponse.new }

  describe 'test an instance of GenericResultResponse' do
    it 'should create an instance of GenericResultResponse' do
      expect(instance).to be_instance_of(HandyAPI::GenericResultResponse)
    end
  end
