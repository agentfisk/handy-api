...
# Unit tests for HandyAPI::ConnectedResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe HandyAPI::ConnectedResponse do
  let(:instance) { HandyAPI::ConnectedResponse.new }

  describe 'test an instance of ConnectedResponse' do
    it 'should create an instance of ConnectedResponse' do
      expect(instance).to be_instance_of(HandyAPI::ConnectedResponse)
    end
  end
