...
# Unit tests for HandyAPI::ModeUpdateResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe HandyAPI::ModeUpdateResponse do
  let(:instance) { HandyAPI::ModeUpdateResponse.new }

  describe 'test an instance of ModeUpdateResponse' do
    it 'should create an instance of ModeUpdateResponse' do
      expect(instance).to be_instance_of(HandyAPI::ModeUpdateResponse)
    end
  end
  describe 'test attribute "result"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('Float', [-1, 0, 1])
