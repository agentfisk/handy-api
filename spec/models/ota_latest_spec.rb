...
# Unit tests for HandyAPI::OtaLatest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe HandyAPI::OtaLatest do
  let(:instance) { HandyAPI::OtaLatest.new }

  describe 'test an instance of OtaLatest' do
    it 'should create an instance of OtaLatest' do
      expect(instance).to be_instance_of(HandyAPI::OtaLatest)
    end
  end
