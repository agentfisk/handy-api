...
# Unit tests for HandyAPI::GenericResult
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe HandyAPI::GenericResult do
  let(:instance) { HandyAPI::GenericResult.new }

  describe 'test an instance of GenericResult' do
    it 'should create an instance of GenericResult' do
      expect(instance).to be_instance_of(HandyAPI::GenericResult)
    end
  end
end
