...
# Unit tests for HandyAPI::NextXPVP
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe HandyAPI::NextXPVP do
  let(:instance) { HandyAPI::NextXPVP.new }

  describe 'test an instance of NextXPVP' do
    it 'should create an instance of NextXPVP' do
      expect(instance).to be_instance_of(HandyAPI::NextXPVP)
    end
  end
