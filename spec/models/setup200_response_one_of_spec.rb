...
# Unit tests for HandyAPI::Setup200ResponseOneOf
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe HandyAPI::Setup200ResponseOneOf do
  let(:instance) { HandyAPI::Setup200ResponseOneOf.new }

  describe 'test an instance of Setup200ResponseOneOf' do
    it 'should create an instance of Setup200ResponseOneOf' do
      expect(instance).to be_instance_of(HandyAPI::Setup200ResponseOneOf)
    end
  end
