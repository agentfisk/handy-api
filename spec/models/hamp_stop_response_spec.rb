...
# Unit tests for HandyAPI::HAMPStopResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe HandyAPI::HAMPStopResponse do
  let(:instance) { HandyAPI::HAMPStopResponse.new }

  describe 'test an instance of HAMPStopResponse' do
    it 'should create an instance of HAMPStopResponse' do
      expect(instance).to be_instance_of(HandyAPI::HAMPStopResponse)
    end
  end
