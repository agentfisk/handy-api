...
# Unit tests for HandyAPI::SlideSettingsAnyOf1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe HandyAPI::SlideSettingsAnyOf1 do
  let(:instance) { HandyAPI::SlideSettingsAnyOf1.new }

  describe 'test an instance of SlideSettingsAnyOf1' do
    it 'should create an instance of SlideSettingsAnyOf1' do
      expect(instance).to be_instance_of(HandyAPI::SlideSettingsAnyOf1)
    end
  end
