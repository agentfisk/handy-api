...
# Unit tests for HandyAPI::StatusResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe HandyAPI::StatusResponse do
  let(:instance) { HandyAPI::StatusResponse.new }

  describe 'test an instance of StatusResponse' do
    it 'should create an instance of StatusResponse' do
      expect(instance).to be_instance_of(HandyAPI::StatusResponse)
    end
  end
