...
# Unit tests for HandyAPI::HDSPTimeRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe HandyAPI::HDSPTimeRequest do
  let(:instance) { HandyAPI::HDSPTimeRequest.new }

  describe 'test an instance of HDSPTimeRequest' do
    it 'should create an instance of HDSPTimeRequest' do
      expect(instance).to be_instance_of(HandyAPI::HDSPTimeRequest)
    end
  end
  describe 'test attribute "stop_on_target"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "immediate_response"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
