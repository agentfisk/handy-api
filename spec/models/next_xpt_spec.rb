...
# Unit tests for HandyAPI::NextXPT
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe HandyAPI::NextXPT do
  let(:instance) { HandyAPI::NextXPT.new }

  describe 'test an instance of NextXPT' do
    it 'should create an instance of NextXPT' do
      expect(instance).to be_instance_of(HandyAPI::NextXPT)
    end
  end
