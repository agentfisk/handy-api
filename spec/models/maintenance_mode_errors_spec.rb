...
# Unit tests for HandyAPI::MAINTENANCEModeErrors
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe HandyAPI::MAINTENANCEModeErrors do
  let(:instance) { HandyAPI::MAINTENANCEModeErrors.new }

  describe 'test an instance of MAINTENANCEModeErrors' do
    it 'should create an instance of MAINTENANCEModeErrors' do
      expect(instance).to be_instance_of(HandyAPI::MAINTENANCEModeErrors)
    end
  end
end
