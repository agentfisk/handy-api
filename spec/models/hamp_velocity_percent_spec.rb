...
# Unit tests for HandyAPI::HAMPVelocityPercent
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe HandyAPI::HAMPVelocityPercent do
  let(:instance) { HandyAPI::HAMPVelocityPercent.new }

  describe 'test an instance of HAMPVelocityPercent' do
    it 'should create an instance of HAMPVelocityPercent' do
      expect(instance).to be_instance_of(HandyAPI::HAMPVelocityPercent)
    end
  end
