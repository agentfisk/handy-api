...
# Unit tests for HandyAPI::HDSPModeErrors
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe HandyAPI::HDSPModeErrors do
  let(:instance) { HandyAPI::HDSPModeErrors.new }

  describe 'test an instance of HDSPModeErrors' do
    it 'should create an instance of HDSPModeErrors' do
      expect(instance).to be_instance_of(HandyAPI::HDSPModeErrors)
    end
  end
end
