...
# Unit tests for HandyAPI::FirmwareStatus
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe HandyAPI::FirmwareStatus do
  let(:instance) { HandyAPI::FirmwareStatus.new }

  describe 'test an instance of FirmwareStatus' do
    it 'should create an instance of FirmwareStatus' do
      expect(instance).to be_instance_of(HandyAPI::FirmwareStatus)
    end
  end
end
