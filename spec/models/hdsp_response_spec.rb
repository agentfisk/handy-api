...
# Unit tests for HandyAPI::HDSPResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe HandyAPI::HDSPResponse do
  let(:instance) { HandyAPI::HDSPResponse.new }

  describe 'test an instance of HDSPResponse' do
    it 'should create an instance of HDSPResponse' do
      expect(instance).to be_instance_of(HandyAPI::HDSPResponse)
    end
  end
