...
# Unit tests for HandyAPI::HAMPModeErrors
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe HandyAPI::HAMPModeErrors do
  let(:instance) { HandyAPI::HAMPModeErrors.new }

  describe 'test an instance of HAMPModeErrors' do
    it 'should create an instance of HAMPModeErrors' do
      expect(instance).to be_instance_of(HandyAPI::HAMPModeErrors)
    end
  end
end
