...
# Unit tests for HandyAPI::PositionAbsoluteResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe HandyAPI::PositionAbsoluteResponse do
  let(:instance) { HandyAPI::PositionAbsoluteResponse.new }

  describe 'test an instance of PositionAbsoluteResponse' do
    it 'should create an instance of PositionAbsoluteResponse' do
      expect(instance).to be_instance_of(HandyAPI::PositionAbsoluteResponse)
    end
  end
