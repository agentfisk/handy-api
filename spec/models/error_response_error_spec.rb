...
# Unit tests for HandyAPI::ErrorResponseError
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe HandyAPI::ErrorResponseError do
  let(:instance) { HandyAPI::ErrorResponseError.new }

  describe 'test an instance of ErrorResponseError' do
    it 'should create an instance of ErrorResponseError' do
      expect(instance).to be_instance_of(HandyAPI::ErrorResponseError)
    end
  end
