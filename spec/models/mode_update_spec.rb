...
# Unit tests for HandyAPI::ModeUpdate
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe HandyAPI::ModeUpdate do
  let(:instance) { HandyAPI::ModeUpdate.new }

  describe 'test an instance of ModeUpdate' do
    it 'should create an instance of ModeUpdate' do
      expect(instance).to be_instance_of(HandyAPI::ModeUpdate)
    end
  end
