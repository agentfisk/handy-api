...
# Unit tests for HandyAPI::HAMPResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe HandyAPI::HAMPResponse do
  let(:instance) { HandyAPI::HAMPResponse.new }

  describe 'test an instance of HAMPResponse' do
    it 'should create an instance of HAMPResponse' do
      expect(instance).to be_instance_of(HandyAPI::HAMPResponse)
    end
  end
