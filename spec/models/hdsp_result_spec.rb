...
# Unit tests for HandyAPI::HDSPResult
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe HandyAPI::HDSPResult do
  let(:instance) { HandyAPI::HDSPResult.new }

  describe 'test an instance of HDSPResult' do
    it 'should create an instance of HDSPResult' do
      expect(instance).to be_instance_of(HandyAPI::HDSPResult)
    end
  end
end
