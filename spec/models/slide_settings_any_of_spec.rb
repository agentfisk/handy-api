...
# Unit tests for HandyAPI::SlideSettingsAnyOf
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe HandyAPI::SlideSettingsAnyOf do
  let(:instance) { HandyAPI::SlideSettingsAnyOf.new }

  describe 'test an instance of SlideSettingsAnyOf' do
    it 'should create an instance of SlideSettingsAnyOf' do
      expect(instance).to be_instance_of(HandyAPI::SlideSettingsAnyOf)
    end
  end
