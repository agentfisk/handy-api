...
# Unit tests for HandyAPI::StateResult
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe HandyAPI::StateResult do
  let(:instance) { HandyAPI::StateResult.new }

  describe 'test an instance of StateResult' do
    it 'should create an instance of StateResult' do
      expect(instance).to be_instance_of(HandyAPI::StateResult)
    end
  end
end
