...
# Unit tests for HandyAPI::GenericError
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe HandyAPI::GenericError do
  let(:instance) { HandyAPI::GenericError.new }

  describe 'test an instance of GenericError' do
    it 'should create an instance of GenericError' do
      expect(instance).to be_instance_of(HandyAPI::GenericError)
    end
  end
