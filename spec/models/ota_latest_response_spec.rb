...
# Unit tests for HandyAPI::OtaLatestResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe HandyAPI::OtaLatestResponse do
  let(:instance) { HandyAPI::OtaLatestResponse.new }

  describe 'test an instance of OtaLatestResponse' do
    it 'should create an instance of OtaLatestResponse' do
      expect(instance).to be_instance_of(HandyAPI::OtaLatestResponse)
    end
  end
