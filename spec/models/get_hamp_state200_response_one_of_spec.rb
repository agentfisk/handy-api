...
# Unit tests for HandyAPI::GetHAMPState200ResponseOneOf
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe HandyAPI::GetHAMPState200ResponseOneOf do
  let(:instance) { HandyAPI::GetHAMPState200ResponseOneOf.new }

  describe 'test an instance of GetHAMPState200ResponseOneOf' do
    it 'should create an instance of GetHAMPState200ResponseOneOf' do
      expect(instance).to be_instance_of(HandyAPI::GetHAMPState200ResponseOneOf)
    end
  end
