...
# Unit tests for HandyAPI::HSSPPlay
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe HandyAPI::HSSPPlay do
  let(:instance) { HandyAPI::HSSPPlay.new }

  describe 'test an instance of HSSPPlay' do
    it 'should create an instance of HSSPPlay' do
      expect(instance).to be_instance_of(HandyAPI::HSSPPlay)
    end
  end
  describe 'test attribute "estimated_server_time"' do
    it 'should work' do
