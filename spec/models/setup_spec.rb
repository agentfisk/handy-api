...
# Unit tests for HandyAPI::Setup
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe HandyAPI::Setup do
  let(:instance) { HandyAPI::Setup.new }

  describe 'test an instance of Setup' do
    it 'should create an instance of Setup' do
      expect(instance).to be_instance_of(HandyAPI::Setup)
    end
  end
