...
# Unit tests for HandyAPI::SlideResult
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe HandyAPI::SlideResult do
  let(:instance) { HandyAPI::SlideResult.new }

  describe 'test an instance of SlideResult' do
    it 'should create an instance of SlideResult' do
      expect(instance).to be_instance_of(HandyAPI::SlideResult)
    end
  end
end
