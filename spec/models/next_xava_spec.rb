...
# Unit tests for HandyAPI::NextXAVA
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe HandyAPI::NextXAVA do
  let(:instance) { HandyAPI::NextXAVA.new }

  describe 'test an instance of NextXAVA' do
    it 'should create an instance of NextXAVA' do
      expect(instance).to be_instance_of(HandyAPI::NextXAVA)
    end
  end
