...
# Unit tests for HandyAPI::HSSPResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe HandyAPI::HSSPResponse do
  let(:instance) { HandyAPI::HSSPResponse.new }

  describe 'test an instance of HSSPResponse' do
    it 'should create an instance of HSSPResponse' do
      expect(instance).to be_instance_of(HandyAPI::HSSPResponse)
    end
  end
  ...
  describe 'test attribute "slide_max"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "slide_min"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
