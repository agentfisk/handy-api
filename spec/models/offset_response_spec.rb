...
# Unit tests for HandyAPI::OffsetResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe HandyAPI::OffsetResponse do
  let(:instance) { HandyAPI::OffsetResponse.new }

  describe 'test an instance of OffsetResponse' do
    it 'should create an instance of OffsetResponse' do
      expect(instance).to be_instance_of(HandyAPI::OffsetResponse)
    end
  end
