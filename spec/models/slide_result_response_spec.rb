...
# Unit tests for HandyAPI::SlideResultResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe HandyAPI::SlideResultResponse do
  let(:instance) { HandyAPI::SlideResultResponse.new }

  describe 'test an instance of SlideResultResponse' do
    it 'should create an instance of SlideResultResponse' do
      expect(instance).to be_instance_of(HandyAPI::SlideResultResponse)
    end
  end
