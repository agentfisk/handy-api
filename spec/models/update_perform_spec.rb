...
# Unit tests for HandyAPI::UpdatePerform
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe HandyAPI::UpdatePerform do
  let(:instance) { HandyAPI::UpdatePerform.new }

  describe 'test an instance of UpdatePerform' do
    it 'should create an instance of UpdatePerform' do
      expect(instance).to be_instance_of(HandyAPI::UpdatePerform)
    end
  end
