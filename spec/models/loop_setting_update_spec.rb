...
# Unit tests for HandyAPI::LoopSettingUpdate
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe HandyAPI::LoopSettingUpdate do
  let(:instance) { HandyAPI::LoopSettingUpdate.new }

  describe 'test an instance of LoopSettingUpdate' do
    it 'should create an instance of LoopSettingUpdate' do
      expect(instance).to be_instance_of(HandyAPI::LoopSettingUpdate)
    end
  end
