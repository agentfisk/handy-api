...
# Unit tests for HandyAPI::RestartRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe HandyAPI::RestartRequest do
  let(:instance) { HandyAPI::RestartRequest.new }

  describe 'test an instance of RestartRequest' do
    it 'should create an instance of RestartRequest' do
      expect(instance).to be_instance_of(HandyAPI::RestartRequest)
    end
  end
