...
# Unit tests for HandyAPI::InfoResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe HandyAPI::InfoResponse do
  let(:instance) { HandyAPI::InfoResponse.new }

  describe 'test an instance of InfoResponse' do
    it 'should create an instance of InfoResponse' do
      expect(instance).to be_instance_of(HandyAPI::InfoResponse)
    end
  end
  ...
  describe 'test attribute "fw_status"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "hw_version"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
