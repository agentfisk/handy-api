...
# Unit tests for HandyAPI::SliderMinResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe HandyAPI::SliderMinResponse do
  let(:instance) { HandyAPI::SliderMinResponse.new }

  describe 'test an instance of SliderMinResponse' do
    it 'should create an instance of SliderMinResponse' do
      expect(instance).to be_instance_of(HandyAPI::SliderMinResponse)
    end
  end
