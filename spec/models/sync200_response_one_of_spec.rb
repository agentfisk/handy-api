...
# Unit tests for HandyAPI::Sync200ResponseOneOf
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe HandyAPI::Sync200ResponseOneOf do
  let(:instance) { HandyAPI::Sync200ResponseOneOf.new }

  describe 'test an instance of Sync200ResponseOneOf' do
    it 'should create an instance of Sync200ResponseOneOf' do
      expect(instance).to be_instance_of(HandyAPI::Sync200ResponseOneOf)
    end
  end
