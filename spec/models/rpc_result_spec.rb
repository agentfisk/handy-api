...
# Unit tests for HandyAPI::RPCResult
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe HandyAPI::RPCResult do
  let(:instance) { HandyAPI::RPCResult.new }

  describe 'test an instance of RPCResult' do
    it 'should create an instance of RPCResult' do
      expect(instance).to be_instance_of(HandyAPI::RPCResult)
    end
  end
