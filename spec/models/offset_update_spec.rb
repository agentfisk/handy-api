...
# Unit tests for HandyAPI::OffsetUpdate
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe HandyAPI::OffsetUpdate do
  let(:instance) { HandyAPI::OffsetUpdate.new }

  describe 'test an instance of OffsetUpdate' do
    it 'should create an instance of OffsetUpdate' do
      expect(instance).to be_instance_of(HandyAPI::OffsetUpdate)
    end
  end
