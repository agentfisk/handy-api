...
# Unit tests for HandyAPI::ServerTimeResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe HandyAPI::ServerTimeResponse do
  let(:instance) { HandyAPI::ServerTimeResponse.new }

  describe 'test an instance of ServerTimeResponse' do
    it 'should create an instance of ServerTimeResponse' do
      expect(instance).to be_instance_of(HandyAPI::ServerTimeResponse)
    end
  end
