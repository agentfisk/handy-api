...
# Unit tests for HandyAPI::ErrorResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe HandyAPI::ErrorResponse do
  let(:instance) { HandyAPI::ErrorResponse.new }

  describe 'test an instance of ErrorResponse' do
    it 'should create an instance of ErrorResponse' do
      expect(instance).to be_instance_of(HandyAPI::ErrorResponse)
    end
  end
