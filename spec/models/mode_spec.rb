...
# Unit tests for HandyAPI::Mode
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe HandyAPI::Mode do
  let(:instance) { HandyAPI::Mode.new }

  describe 'test an instance of Mode' do
    it 'should create an instance of Mode' do
      expect(instance).to be_instance_of(HandyAPI::Mode)
    end
  end
end
