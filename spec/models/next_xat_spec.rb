...
# Unit tests for HandyAPI::NextXAT
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe HandyAPI::NextXAT do
  let(:instance) { HandyAPI::NextXAT.new }

  describe 'test an instance of NextXAT' do
    it 'should create an instance of NextXAT' do
      expect(instance).to be_instance_of(HandyAPI::NextXAT)
    end
  end
