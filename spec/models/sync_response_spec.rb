...
# Unit tests for HandyAPI::SyncResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe HandyAPI::SyncResponse do
  let(:instance) { HandyAPI::SyncResponse.new }

  describe 'test an instance of SyncResponse' do
    it 'should create an instance of SyncResponse' do
      expect(instance).to be_instance_of(HandyAPI::SyncResponse)
    end
  end
  ...
  describe 'test attribute "dtserver"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
