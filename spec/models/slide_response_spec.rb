...
# Unit tests for HandyAPI::SlideResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe HandyAPI::SlideResponse do
  let(:instance) { HandyAPI::SlideResponse.new }

  describe 'test an instance of SlideResponse' do
    it 'should create an instance of SlideResponse' do
      expect(instance).to be_instance_of(HandyAPI::SlideResponse)
    end
  end
