...
# Unit tests for HandyAPI::HAMPStartResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe HandyAPI::HAMPStartResponse do
  let(:instance) { HandyAPI::HAMPStartResponse.new }

  describe 'test an instance of HAMPStartResponse' do
    it 'should create an instance of HAMPStartResponse' do
      expect(instance).to be_instance_of(HandyAPI::HAMPStartResponse)
    end
  end
