...
# Unit tests for HandyAPI::LoopSettingResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe HandyAPI::LoopSettingResponse do
  let(:instance) { HandyAPI::LoopSettingResponse.new }

  describe 'test an instance of LoopSettingResponse' do
    it 'should create an instance of LoopSettingResponse' do
      expect(instance).to be_instance_of(HandyAPI::LoopSettingResponse)
    end
  end
