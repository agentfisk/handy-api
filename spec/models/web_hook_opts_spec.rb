...
# Unit tests for HandyAPI::WebHookOpts
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe HandyAPI::WebHookOpts do
  let(:instance) { HandyAPI::WebHookOpts.new }

  describe 'test an instance of WebHookOpts' do
    it 'should create an instance of WebHookOpts' do
      expect(instance).to be_instance_of(HandyAPI::WebHookOpts)
    end
  end
