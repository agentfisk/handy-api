...
# Unit tests for HandyAPI::HDSPRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe HandyAPI::HDSPRequest do
  let(:instance) { HandyAPI::HDSPRequest.new }

  describe 'test an instance of HDSPRequest' do
    it 'should create an instance of HDSPRequest' do
      expect(instance).to be_instance_of(HandyAPI::HDSPRequest)
    end
  end
