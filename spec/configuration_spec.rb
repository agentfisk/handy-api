...
describe HandyAPI::Configuration do
  let(:config) { HandyAPI::Configuration.default }

  before(:each) do
    # uncomment below to setup host and base_path
    # require 'URI'
    # uri = URI.parse("https://www.handyfeeling.com/api/handy/v2")
    # HandyAPI.configure do |c|
    #   c.host = uri.host
  ...
  describe '#base_url' do
    it 'should have the default value' do
      ...
      # expect(config.base_url).to eq("https://www.handyfeeling.com/api/handy/v2")
    end
